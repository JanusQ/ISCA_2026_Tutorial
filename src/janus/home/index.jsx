              ...
              >
                ...
                <div className="home_overview" ref={Overview}>
                  ...
                  <div className="home_overview_content">
                    In this tutorial, we present Janus 4.0, an open-source framework for quantum-classical heterogeneous architecture and flexible scheduling. The tutorial begins with the Janus quantum cloud platform, which connects to superconducting processors developed by Zhejiang University. We then introduce Qtenon, a tightly coupled RISC-V architecture that unifies the memory hierarchy between the host and quantum accelerator, supports custom instructions for dynamic incremental compilation, and enables fine-grained synchronization for low-latency hybrid quantum-classical computing (ISCA 2025). For distributed quantum computing, we introduce AdaptDQC, an adaptive compiler framework that models temporal and spatial communication with a unified graph and optimizes communication cost under diverse inter-chip architectures (TC 2025). We then cover EXP-QRAM, an experimental realization of bucket-brigade quantum random access memory on superconducting devices (Nature Physics). To address the feedback latency wall in real-time control, we present ARTERY, a fast quantum feedback system that combines historical branch statistics and real-time readout trajectory analysis for speculative quantum-gate pre-execution (ISCA 2025). The tutorial closes with Choco-Q, a quantum application framework for constrained binary optimization (HPCA 2025).
                  </div>
